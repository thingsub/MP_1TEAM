...
public class FifthActivity extends AppCompatActivity {
    ...
    private final String[] gridLetters = {"새", "학", "기", "휴", "강", "습", "자", "정", "학", "업", "박", "물"};
        ...
        buttonPass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (textView.getText().length() > 0) {
                    ...
                    showToast("아쉽네요! 답은 '휴학' 입니다.");
                    // If there is no text in textView, go to SecondActivity
                    Intent intent = new Intent(FifthActivity.this, ResultActivity.class);
        ...
        builder.setTitle("알림")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent = new Intent(FifthActivity.this, SolveActivity.class);
                        startActivity(intent);
    ...
    // 초성 힌트를 토스트 메시지로 출력하는 메서드
    private void showHintToast() {
        String hintText = "대학교 다닐때 꼭 해봐야하는 것\n";
